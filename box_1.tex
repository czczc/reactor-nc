...
\end{equation}
The probability that we detect $\nu_e$ at the distance $L$ is just the square of the corresponding amplitude, and correspondingly the probability
of detecting $\nu_{\alpha}$ is the square of that amplitude. Therefore, after a bit of a simple algebra,
\begin{equation}
...
Thus, we see that, provided $\Delta m^2 \ne 0$, the composition of the neutrino beam oscillates as a function of $L/E_{\nu}$ 
...
a nontrivial one, i.e. that the mixing angle is neither $\theta = 0$ nor $\theta = \pi/2$. Generalization to the realistic case of three neutrino flavors and three
